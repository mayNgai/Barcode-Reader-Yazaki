...
public class CheckPermission extends Activity {
    ...
    public static boolean checkAndRequestPermissions(Context mContext, Activity act) {
        ...
        int pWriteStorage = ContextCompat.checkSelfPermission(mContext, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        int pReadStorage = ContextCompat.checkSelfPermission(mContext, Manifest.permission.READ_EXTERNAL_STORAGE);
        int pInternet = ContextCompat.checkSelfPermission(mContext, Manifest.permission.READ_PHONE_STATE);
        int pAccessLocation = ContextCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_FINE_LOCATION);
...
//                        // shouldShowRequestPermissionRationale will return true
                        ...
                        if (ActivityCompat.shouldShowRequestPermissionRationale(CheckPermission.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                                || ActivityCompat.shouldShowRequestPermissionRationale(CheckPermission.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                                || ActivityCompat.shouldShowRequestPermissionRationale(CheckPermission.this, Manifest.permission.READ_PHONE_STATE)
